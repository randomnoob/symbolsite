...
# symbol_space/
APPS_DIR = ROOT_DIR / "symbol_space"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "symbol_space.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "symbol_space.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "symbol_space.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "symbol_space.users.adapters.SocialAccountAdapter"
